...
import {
  createMnemonic,
  mnemonicToHandle,
} from "../../../ts-client-library/packages/util/src/mnemonic";
import {
  Account,
  AccountGetRes,
...
import {
  bytesToHex,
  hexToBytes,
} from "../../../ts-client-library/packages/util/src/hex";
      ...
      <Modal.Body>
        {plan && (
          <div className="signup-process">
            ...
            <div
              className={
                currentStep === 1 ? "process-item active" : "process-item"
              }
            >
              <div className="process-image">
            ...
            <div
              className={
                currentStep === 2 ? "process-item active" : "process-item"
              }
            >
              <div className="process-image">
            ...
            <div
              className={
                currentStep === 3 ? "process-item active" : "process-item"
              }
            >
              <div className="process-image">
...
const AccountHandle: React.FC<SignUpProps> = ({
  plan,
  goBack,
  goNext,
  mnemonic,
        ...
        <form onSubmit={handleSubmit} autoComplete="off">
          <Row className="align-items-center ">
            <Col className="text-center">
              {plan ? (
                <h2 className="plans">
                  IMPORTANT: Save Your Account Handle Recovery Phrase
                </h2>
              ) : (
                <>
              ...
              <h3>
                Your Privacy and <span>Security is in your hands.</span> Keep
                These Numbers <span>Safe.</span>
              </h3>
            </Col>
          </Row>
          <Row>
            <Col md="12">
              <Form.Group>
                ...
                <CopyToClipboard
                  text={handle}
                  onCopy={() => handle && setIsCopied(true)}
                >
        ...
        {paymentMethod === "crypto" && (
          <div>
            ...
            <div className="send-email">
              Send {plan.opctCost} OPCT to Ethereum Address:
            </div>
            <div className="form-group">
              <div className="account-handle">{invoice.ethAddress}</div>
              <CopyToClipboard
                text={invoice.ethAddress}
                onCopy={() => invoice.ethAddress && setIsCopied(true)}
              >
                <span className="handle"></span>
              </CopyToClipboard>
              {isCopied && (
            ...
            <div className="need-opct">
              ...
              <span
                className="here"
                onClick={() =>
                  window.open("https://www.kucoin.com/trade/OPCT-BTC", "_blank")
                }
              >
                Purchase here
              </span>
            ...
            <div className="row qrcode">
              <Col>
                ...
                <Redeem
                  ...
                  ethAddress={invoice.ethAddress}
                />
              </Col>
              <Col>
                <div className="scan">
                  <h3 className="subtitle-bottom-effect">
                    Scan QR code to pay
                  </h3>
                  <QRCode
                    value={"ethAddress"}
...
const ConfirmPayment: React.FC<SignUpProps> = ({
  plan,
  handle,
