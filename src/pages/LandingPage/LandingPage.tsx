    ...
    <SiteWrapper showSignUpModal={showSignUpModal} handleCloseSignUpModal={handleCloseSignUpModal} isHome={true} history={history}>
          ...
          <div className='col-md-12' data-aos='fade-up'>
            <div className='row justify-content-center'>
              <div className='col-md-5 pr-4'>
                ...
                <div className='descriptions'>
                  <p className='mb-4'>No Personal Information Means 100% Trust</p>
                  <p className='mb-4'>
                    Only Opacity can guarantee your information will never be leaked or used by 3rd party ads. Because we don't ask for it! Your name,
                    address, or credit card will never be compromised. We respect your privacy by keeping you out of the transaction.
                  </p>
                </div>
              </div>
              <div className='col-md-5 pl-4'>
      ...
      <div className='third-ele text-center' data-aos='fade-up'>
        <div className='container-xl'>
          ...
          <h3>
            Not only can you enjoy 100% private data storage, we use client side end-to-end encryption you won’t find on most other file hosting
            sites. We’re always expanding our capabilities to remain one step ahead of our competitors, making our file upload system the best choice
