        ...
        <Row className='justify-content-md-center'>
          <Col md='7' className='text-center'>
            ...
            <h3 className='page1-description-small mb-5'>
              <p>
                We understand the need for privacy. That’s why our architecture ensures only you control access to your personal data. This level of
                account privacy means that Opacity does not retain any record of your account information, including the Account Handle created to
                access your account.
              </p>
              <p>
                To avoid any potential loss of access, we recommend using a password manager to safely store your Opacity credentials. In addition,
                these other applications will help improve your experience:
              </p>
            </h3>
          </Col>
        </Row>
            ...
            <Media>
              ...
              <Media.Body>
                <p>
                  ...
                  Current version: 1.0, <strong style={{ color: "#2E6DDE" }}>2.0 Coming Soon!</strong>
                </p>
                <NavLink>
